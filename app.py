...
st.markdown("<br><br>", unsafe_allow_html=True)
st.markdown("<div style='text-align: center; color: #444; font-family: \"Press Start 2P\", cursive; font-size: 0.6rem;'>EDUPREDICT SYSTEM | (C) 2026<br>INSERT COIN TO CONTINUE</div>", unsafe_allow_html=True)   i want to change press start to predict nutton asthetic as a flikering light button with siren warning 
